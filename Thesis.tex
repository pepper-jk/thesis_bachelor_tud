...
The most common methods to achieve DP are clipping the weights, which will be sending to the server, and the addition of noise before averaging weights in order to anonymize the single contributions and minimize the extractable information about the user.
