...
As NNs works best with continuous data we face the following problems when converting the data:
...
Each data point has a general structure of a list of flow features and a sequence of packets.
...
Both used the output of a CNN, that provided a continuous vector representation of an image, as the conditional input for their RNN.
