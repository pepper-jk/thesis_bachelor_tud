...
We add the TCP flags and options as well as the sequence number and window size with a masking value (-15) at the same positions where they would be in a TCP feature vector, more on that in section \ref{sec:packtFeatures}.
