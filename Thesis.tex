...
Later we randomly apply modifications to those samples to create negative data points.
...
The last part is especially important to keep the data points comparable.
