...
However, there is a lot of depth to an NN model implementation and we could not explore all of them.
...
Even with the addition word2vec weights, this would most likely never be as much as the data we used.
