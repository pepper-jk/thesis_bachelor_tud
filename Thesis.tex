...
As our datasets (\ref{tab:datapoints}) had the same ratio of positive to negative datapoints, we assumed the true accuracy of our model to be 50\% at best, so not better as a coin toss.
...
\textbf{Method 3} and \textbf{method 4} alter the sequence of packets, which is way more powerful, especially in reagards to the recurrent architecture of our model.
As for the problematic samples, we assume that they had only small changes.
For example, they could have been created from positive samples with a small packet count and therefore only got a small reduction of packets (method 3), or two very similar flows got their packet seqeunce switched (method 4).
...
\begin{figure}
    \includegraphics[width=\textwidth]{hinge_val_accuracy.pdf}
    \includegraphics[width=\textwidth]{hinge_val_loss.pdf}
...
\begin{figure}
    \includegraphics[width=\textwidth]{1000_val_accuracy.pdf}
    \includegraphics[width=\textwidth]{1000_val_loss.pdf}
...
\begin{figure}
    \includegraphics[width=\textwidth]{batchsize_val_accuracy.pdf}
    \includegraphics[width=\textwidth]{batchsize_val_loss.pdf}
...
\begin{figure}
    \includegraphics[width=\textwidth]{layers_val_accuracy.pdf}
    \includegraphics[width=\textwidth]{layers_val_loss.pdf}
...
\begin{figure}
    \includegraphics[width=\textwidth]{dataset_percentage_val_accuracy.pdf}
    \includegraphics[width=\textwidth]{dataset_percentage_val_loss.pdf}
...
\begin{figure}
    \includegraphics[width=\textwidth]{dataset_negative_samples_val_accuracy.pdf}
    \includegraphics[width=\textwidth]{dataset_negative_samples_val_loss.pdf}
    \caption{Comparison of both validation accuracy and loss between datasets with various negative sample configurations, see \ref{tab:negativeSamples}.} %TODO: parameters used LSTM_nn_64_units_2_layers_100_epochs_500_batchsiz
    \label{fig:dataset_negative}
\end{figure}

\begin{figure}
    \includegraphics[width=\textwidth]{negative_sample_methods_val_accuracy.pdf}
    \includegraphics[width=\textwidth]{negative_sample_methods_val_loss.pdf}
    \caption{Comparison of both validation accuracy and loss between x and y.} %TODO: parameters used LSTM_nn_96_units_2_layers_100_epochs_350_batchsiz
