...
% FIXME: move this to features?
The data offset and IP header length (IHL) are also used as an indicating boolean for TCP and IP options respectively.

The protocol will be represented as a single boolean as our dataset only contains TCP and UDP, where 1 stands for TCP and 0 for UDP.
...
The checksums are a perfect example for a feature derivation.
