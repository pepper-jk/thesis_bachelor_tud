...
Adding some of the trivial features as binary representation with the purpose of indicating the validity of the feature.
Brining in more meta data extracted by Wiresharek, or more network flow statistics.
Exploring other network flow representations.
Or as stated before additional subcategories for system and registerd ports, for examples categories for different services or importance of said services.
