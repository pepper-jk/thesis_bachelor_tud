...
% TODO: maybe talk about the vanishing gradient problem more?
...
So using LSTMs or GRUs solve the vanishing gradient problem for seqeuntial input.
In our case however, we do provide more than one input and not all of it is sequential.
...
This allows the conditional data to be taken into account without appending it to each timestamp in the seqeunce.
...
Even though Ring et al. \cite{ringFlowbasedNetworkTraffic2019a} do not create network packet captures,
their choice and classification of network flow features is valuable research for this thesis.
% TODO: explain more?
